(function() {
  ...
  /** es6 style */
  _.extend = (obj, ...objList) => {
    return _.reduce(objList, (memo, nextObj) => {
      _.each(nextObj, (val, key) => memo[key] = val);
      return memo;
    }, obj);
  };
...
/** es6 style */
  ...
  _.flatten = function(nestedArray, result) {
    return _.reduce(nestedArray, function(memo, next) {
      return memo.concat(
        Array.isArray(next) ? _.flatten(next) : next
      );
    }, []);
  };
